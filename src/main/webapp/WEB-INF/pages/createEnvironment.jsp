                ...
                <div class="main-content">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <form:form id="myForm" name="myForm" method="post" action="saveEnvironment" modelAttribute="environment" class="form-horizontal" onsubmit="jQuery.blockUI({ message: '<h4><img src=\'../assets/img/busy.gif\' /> Please wait</h4>' }); return true;">  
